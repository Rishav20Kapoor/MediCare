...
import { BadgeIndianRupee, CalendarRange, CheckCircle, UserRoundCheck, XCircle , Users , Search } from 'lucide-react';
...
const DashboardPage = () => {
    ...
    // to load doctor from the server side
    ...
    <div className = {s.pageContainer}>
        <div className={s.maxWidthContainer}>
            ...
            <div className = {s.statsGrid}>
                ...
                <StatCard // show fetching from backend 
                ...
                <div className = {s.showMoreContainer}>
                  <button onClick = {() => setShowAll((s) => !s)}
                    className = {s.showMoreButton + " " + s.cursorPointer}>
                      {showAll 
                        ? "Show less" 
                        : `Show More (${filterDoctors.length - INTIAL_COUNT})`
                      }
                  </button>
                </div>
              )}
      ...
      <div className = {s.mobileDoctorHeader}>
        ...
        <div className= {s.mobileDoctorFee}>Rs.{d.fee}</div>
          ...
          <div className = {s.mobileEarningsContainer}>
            <div> Earned </div>
            <div className = {"font - semibold"}> Rs. {d.earning.toLocalString()} </div>
          </div>
      </div>
  )
}