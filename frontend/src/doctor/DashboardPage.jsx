...
// function to get the time in 24 hours 
...
// to convert 12 hrs to 24 hourse clock 
...
// to get these details sfrom server side 
...
export default function DashboardPage({ apiBase }) {
  ...
  // to fetch the appointmente by id 
  ...
  // sorting the value by time for filter
  ...
  // to reschedue the appointment
  // also check whether appt is cnacel or completed then we cannot change 
